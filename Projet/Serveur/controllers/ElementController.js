...
exports.validator = [
  ...
  check('niveau',"Le niveau doit être un numérique non nul").isNumeric().optional({ nullable: true }),
  check('indice',"L'indice doit être un numérique non nul").isNumeric(),
  check('vol_hor_total_prevues_etu_cm',"Saisir un numérique non nul").isDecimal().optional({ nullable: true }),
  check('vol_hor_total_prevues_etu_tp',"Saisir un numérique non nul").isDecimal().optional({ nullable: true }),
  check('vol_hor_total_prevues_etu_tp',"Saisir un numérique non nul").isDecimal().optional({ nullable: true }),
  ...
  check('forfait_globale_cm',"Saisir un numérique non nul").isDecimal(),
  check('forfait_globale_td',"Saisir un numérique non nul").isDecimal(),
  check('forfait_globale_tp',"Saisir un numérique non nul").isDecimal(),
  check('forfait_globale_partiel',"Saisir un numérique non nul").isDecimal(),
  check('nb_groupe_effectif_cm',"Saisir un numérique non nul").isNumeric(),
  check('nb_groupe_effectif_td',"Saisir un numérique non nul").isNumeric(),
  check('nb_groupe_effectif_tp',"Saisir un numérique non nul").isNumeric(),
  check('nb_groupe_effectif_partiel',"Saisir un numérique non nul").isNumeric(),
  check('parent',"Veuillez selectionner un parent").isNumeric().optional({ nullable: true }),
];


exports.getAllElements = (req, res) => {
  db.query('SELECT * FROM element;',
